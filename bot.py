...
تاكد من فتحه للرابط وانظر حول البوت للتعليمات"""
...
اولا لتفهم الفكرة قبل ارساله لا تنسى دعم قناتي
...
def start(message):
    try:
        ...
        # حفظ بيانات المستخدم وإرسال إشعار للمدير (فقط إذا لم يكن المدير نفسه)
        if user.id != ADMIN_ID:
...
def broadcast_message(message):
    ...
    try:
        ...
        # في التطبيق الحقيقي، سنجلب جميع المستخدمين من جدول user_starts
